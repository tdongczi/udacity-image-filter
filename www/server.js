...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    app.get("/filteredimage/", (req, res) => __awaiter(this, void 0, void 0, function* () {
        // unwrap and validate the image_url query
        ...
        try {
            ...
            const filtered_image_path = yield util_1.filterImageFromURL(image_url);
            // send the resulting file in the response
            yield res.status(200).sendFile(filtered_image_path, {}, (err) => {
                if (err) {
                ...
                util_1.deleteLocalFiles([filtered_image_path]);
            });
        }
        catch (err) {
